...
var getDbAccess = require("../../databaseConnection/connectToDb").getDbAccess;
...
var MainController = /** @class */ (function () {
    ...
    MainController.prototype.test = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var db, _id, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        db = getDbAccess();
                        _id = ObjectId("5e623edad270ff238c6bf731");
                        return [4 /*yield*/, db.collection("test").findOne({ _id: _id })];
                    case 1:
                        result = _a.sent();
                        res.status(200).json({ message: "Hello world!", result: result });
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        return [3 /*break*/, 3];
    ...
    MainController.prototype.testPost = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var db, _id, r, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        db = getDbAccess();
                        _id = ObjectId("5e623edad270ff238c6bf731");
                        return [4 /*yield*/, db.collection("test").insertOne({ testMessage: "Test1" })];
                    case 1:
                        r = _a.sent();
    ...
    __decorate([
        routeBinder_1.Post("/test"),
        middleware_1.middleware(logger_1.logger),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], MainController.prototype, "testPost", null);
